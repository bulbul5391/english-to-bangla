...
<div class="flex flex-col justify-center items-center mt-10">
    <p class="text-green-700 text-3xl mb-8">
        Welcome to My English to Bangla Translate Package
    </p>
    <form method="post" action="{{route('checking')}}" class="w-3/5">
        @csrf
        <div class="grid grid-cols-2 gap-4 justify-center">
            <div>
                <label for="info" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Enter Number/Day/Month</label>
